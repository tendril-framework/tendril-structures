...
setup(
    name='tendril-structures',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Tendril Entity Structures and Associated Infrastructure",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-structures',
    project_urls={
        'Documentation': 'https://tendril-structures.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-structures/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-structures',
    },
