...
``tendril-structures`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-structures
...
`github releases <https://github.com/tendril-framework/tendril-structures/releases>`_.
...
``tendril-structures``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-structures.git
    $ cd tendril-structures
    $ pip install -e .
